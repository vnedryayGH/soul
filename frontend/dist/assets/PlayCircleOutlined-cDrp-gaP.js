...
const PlayCircleOutlined = (props, ref) => /* @__PURE__ */ reactExports.createElement(Icon, _extends({}, props, {
  ref,
  icon: PlayCircleOutlined$1
}));
const RefIcon = /* @__PURE__ */ reactExports.forwardRef(PlayCircleOutlined);
export {
  RefIcon as R
};
//# sourceMappingURL=PlayCircleOutlined-cDrp-gaP.js.map
