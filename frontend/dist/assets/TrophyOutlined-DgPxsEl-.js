...
const TrophyOutlined = (props, ref) => /* @__PURE__ */ reactExports.createElement(Icon, _extends({}, props, {
  ref,
  icon: TrophyOutlined$1
}));
const RefIcon = /* @__PURE__ */ reactExports.forwardRef(TrophyOutlined);
export {
  RefIcon as R
};
//# sourceMappingURL=TrophyOutlined-DgPxsEl-.js.map
